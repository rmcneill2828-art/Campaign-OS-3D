...
const SYSTEM_PROMPT = [
  ...
  "expiring, an NPC leaving the scene for good, cleaning up a temporary/mistaken spawn. This is",
  "permanent and undoable, unlike toggle_condition's hiddenFromPlayers or a token merely",
  "dropping to 0 HP -- only use it when the token genuinely shouldn't exist in this encounter",
  "anymore, not as a stand-in for \"it died\" (a dead token stays on the map, visibly dead, which",
  "is usually what narration actually wants).",
  "",
